 ...
 * @access public
 */
class Moxo_Customize_Control_Tabs extends WP_Customize_Control {

	/**
	 * Moxo_Customize_Control_Tabs constructor.
	 *
	...
	public function render_content() {
		...
		foreach ( $this->tabs as $value => $args ) {
			if ( ! empty( $args['controls'] ) && ( $this->tab_has_controls( $args['controls'] ) ) ) {
				...
				$output .= '</label>';
				$output .= '</div><!-- /.moxo-customizer-tab -->';
			}
		}
		$output .= '</div><!-- /.moxo-tabs-control -->';
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'moxo-tabs-control-script', MOXO_PLUGIN_URL . '/inc/custom-controls/Tabs/js/script.js', array( 'jquery' ), 'moxo', true );
		wp_enqueue_style( 'moxo-tabs-control-style', MOXO_PLUGIN_URL . '/inc/custom-controls/Tabs/css/style.css', null,'moxo');

	}

	/**
	 * Enqueue the partials handler script that works synchronously with the moxo-tabs-control-script
	 */
	public function partials_helper_script_enqueue() {
		wp_enqueue_script( 'moxo-tabs-addon-script', MOXO_PLUGIN_URL . '/inc/custom-controls/Tabs/js/customizer-addon-script.js', array( 'jquery' ),true );
	}
